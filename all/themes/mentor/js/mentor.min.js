...
function (e, t) {
  ...
  function c(e, i) {
    ...
    var n, s, a, r, o, l, c, d, h = e.dataTypes,
      ...
      f = h[0];
    for (n = 1; p > n; n++) {
      if (1 === n) for (s in e.converters)"string" == typeof s && (u[s.toLowerCase()] = e.converters[s]);
      if (r = f, f = h[n], "*" === f) f = r;
      else if ("*" !== r && r !== f) {
        if (o = r + " " + f, l = u[o] || u["* " + f], !l) {
          d = t;
          for (c in u) if (a = c.split(" "), (a[0] === r || "*" === a[0]) && (d = u[a[1] + " " + f])) {
  ...
  function h(e, t, i, n) {
    ...
    else for (var s in t) h(e + "[" + s + "]", t[s], i, n)
  }
  function u(e, i) {
  ...
  function f(e) {
    return function (t, i) {
      if ("string" != typeof t && (i = t, t = "*"), G.isFunction(i)) for (var n, s, a, r = t.toLowerCase().split(ti), o = 0, l = r.length; l > o; o++) n = r[o], a = /^\+/.test(n), a && (n = n.substr(1) || "*"), s = e[n] = e[n] || [], s[a ? "unshift" : "push"](i)
    }
  }
  function m(e, t, i) {
    var n = "width" === t ? e.offsetWidth : e.offsetHeight,
      ...
      a = 4;
    if (n > 0) {
      if ("border" !== i) for (; a > s; s += 2) i || (n -= parseFloat(G.css(e, "padding" + Ft[s])) || 0), "margin" === i ? n += parseFloat(G.css(e, i + Ft[s])) || 0 : n -= parseFloat(G.css(e, "border" + Ft[s] + "Width")) || 0;
      return n + "px"
    }
    if (n = Et(e, t), (0 > n || null == n) && (n = e.style[t]), Ot.test(n)) return n;
    if (n = parseFloat(n) || 0, i) for (; a > s; s += 2) n += parseFloat(G.css(e, "padding" + Ft[s])) || 0, "padding" !== i && (n += parseFloat(G.css(e, "border" + Ft[s] + "Width")) || 0), "margin" === i && (n += parseFloat(G.css(e, i + Ft[s])) || 0);
    return n + "px"
  }
  function g(e) {
  ...
  function w(e, t) {
    if (1 === t.nodeType && G.hasData(e)) {
      ...
      if (o) {
        ...
        for (i in o) for (n = 0, s = o[i].length; s > n; n++) G.event.add(t, i, o[i][n])
      }
    ...
    G = function () {
      ...
      return o.fn = o.prototype = {
        ...
        var e, i, n, s, a, r, l = arguments[0] || {},
          ...
          d = arguments.length,
          h = !1;
        for ("boolean" == typeof l && (h = l, l = arguments[1] || {}, c = 2), "object" != typeof l && !o.isFunction(l) && (l = {}), d === c && (l = this, --c); d > c; c++) if (null != (e = arguments[c])) for (i in e) n = l[i], s = e[i], l !== s && (h && s && (o.isPlainObject(s) || (a = o.isArray(s))) ? (a ? (a = !1, r = n && o.isArray(n) ? n : []) : r = n && o.isPlainObject(n) ? n : {}, l[i] = o.extend(h, r, s)) : s !== t && (l[i] = s));
        return l
      }, o.extend({
        ...
        each: function (e, i, n) {
          ...
          } else for (; r > a && i.apply(e[a++], n) !== !1;);
          else if (l) {
            for (s in e) if (i.call(e[s], s, e[s]) === !1) break
          } else for (; r > a && i.call(e[a], a, e[a++]) !== !1;);
          return e
        },
        trim: H ?
        function (e) {
        ...
        merge: function (e, i) {
          var n = e.length,
            s = 0;
          if ("number" == typeof i.length) for (var a = i.length; a > s; s++) e[n++] = i[s];
        ...
        map: function (e, i, n) {
          ...
          if (d) for (; c > l; l++) s = i(e[l], l, n), null != s && (r[r.length] = s);
          else for (a in e) s = i(e[a], a, n), null != s && (r[r.length] = s);
        ...
        access: function (e, i, n, s, a, r, l) {
          ...
          if (n && "object" == typeof n) {
            ...
            if (c = l === t && o.isFunction(s), d && (c ? (c = i, i = function (e, t, i) {
              return c.call(o(e), i)
            }) : (i.call(e, s), i = null)), i) for (; u > h; h++) i(e[h], n, c ? s.call(e[h], h, i(e[h], n)) : s, l);
            a = 1
          }
  ...
  G.Callbacks = function (e) {
    ...
    var i, n, s, a, r, o, l = [],
      ...
      h = function (t, d) {
        for (d = d || [], i = !e.memory || [t, d], n = !0, s = !0, o = a || 0, a = 0, r = l.length; l && r > o; o++) if (l[o].apply(t, d) === !1 && e.stopOnFalse) {
          i = !0;
          break
        }
      ...
      u = {
        ...
        remove: function () {
          if (l) for (var t = arguments, i = 0, n = t.length; n > i; i++) for (var a = 0; a < l.length && (t[i] !== l[a] || (s && r >= a && (r--, o >= a && o--), l.splice(a--, 1), !e.unique)); a++);
          return this
        },
        has: function (e) {
          if (l) for (var t = 0, i = l.length; i > t; t++) if (e === l[t]) return !0;
          return !1
        },
        empty: function () {
          return l = [], this
  ...
  G.extend({
    ...
    if (!u.addEventListener && u.attachEvent && u.fireEvent && (u.attachEvent("onclick", function () {
      t.noCloneEvent = !1
    }), u.cloneNode(!0).fireEvent("onclick")), r = A.createElement("input"), r.value = "t", r.setAttribute("type", "radio"), t.radioValue = "t" === r.value, r.setAttribute("checked", "checked"), r.setAttribute("name", "t"), u.appendChild(r), o = A.createDocumentFragment(), o.appendChild(u.lastChild), t.checkClone = o.cloneNode(!0).cloneNode(!0).lastChild.checked, t.appendChecked = r.checked, o.removeChild(r), o.appendChild(u), u.attachEvent) for (d in {
      submit: 1,
      change: 1,
      focusin: 1
  ...
  G.fn.extend({
    ...
    addClass: function (e) {
      ...
      if (e && "string" == typeof e) for (t = e.split(z), i = 0, n = this.length; n > i; i++) if (s = this[i], 1 === s.nodeType) if (s.className || 1 !== t.length) {
    ...
    removeClass: function (e) {
      ...
      if (e && "string" == typeof e || e === t) for (i = (e || "").split(z), n = 0, s = this.length; s > n; n++) if (a = this[n], 1 === a.nodeType && a.className) if (e) {
    ...
    toggleClass: function (e, t) {
      ...
      return G.isFunction(e) ? this.each(function (i) {
        ...
        if ("string" === i) for (var s, a = 0, r = G(this), o = t, l = e.split(z); s = l[a++];) o = n ? o : !r.hasClass(s), r[o ? "addClass" : "removeClass"](s);
    ...
    hasClass: function (e) {
      for (var t = " " + e + " ", i = 0, n = this.length; n > i; i++) if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(V, " ").indexOf(t) > -1) return !0;
      return !1
    },
    val: function (e) {
      var i, n, s, a = this[0];
      ...
      select: {
        get: function (e) {
          var t, i, n, s, a = e.selectedIndex,
            ...
            l = "select-one" === e.type;
          if (0 > a) return null;
          for (i = l ? a : 0, n = l ? a + 1 : o.length; n > i; i++) if (s = o[i], !(!s.selected || (G.support.optDisabled ? s.disabled : null !== s.getAttribute("disabled")) || s.parentNode.disabled && G.nodeName(s.parentNode, "optgroup"))) {
    ...
    removeAttr: function (e, t) {
      var i, n, s, a, r, o = 0;
      if (t && 1 === e.nodeType) for (n = t.toLowerCase().split(z), a = n.length; a > o; o++) s = n[o], s && (i = G.propFix[s] || s, r = Q.test(s), r || G.attr(e, s, ""), e.removeAttribute(Y ? s : i), r && i in e && (e[i] = !1))
    },
    attrHooks: {
      type: {
        set: function (e, t) {
  ...
  G.event = {
    ...
    remove: function (e, t, i, n, s) {
      ...
      if (v && (u = v.events)) {
        for (t = G.trim(rt(t || "")).split(" "), a = 0; a < t.length; a++) if (r = X.exec(t[a]) || [], o = l = r[1], c = r[2], o) {
        ...
        } else for (o in u) G.event.remove(e, o + t[a], i, n, !0);
    ...
    dispatch: function (i) {
      ...
      if (m[0] = i, i.delegateTarget = this, !v.preDispatch || v.preDispatch.call(this, i) !== !1) {
        if (f && (!i.button || "click" !== i.type)) for (r = G(this), r.context = this.ownerDocument || this, a = i.target; a != this; a = a.parentNode || this) if (a.disabled !== !0) {
  ...
  }, G.event.handle = G.event.dispatch, G.removeEvent = A.removeEventListener ?
  function (e, t, i) {
      ...
      for (var o = 0, l = n.length; l > o; o++) {
        ...
        if (c) {
          ...
          for (c = c[e]; c;) {
            ...
            if (1 === c.nodeType) if (r || (c[s] = i, c.sizset = o), "string" != typeof t) {
              if (c === t) {
                d = !0;
                break
              }
    ...
    var u = function (e, t, i, s) {
        ...
        while (o);
        if (w.length > 1 && m.exec(e)) if (2 === w.length && f.relative[w[0]]) l = x(w[0] + w[1], t, s);
        else for (l = f.relative[w[0]] ? [t] : u(w.shift(), t); w.length;) e = w.shift(), f.relative[e] && (e += w.shift()), l = x(e, l, s);
        else if (!s && w.length > 1 && 9 === t.nodeType && !y && f.match.ID.test(w[0]) && !f.match.ID.test(w[w.length - 1]) && (h = u.find(w.shift(), t, y), t = h.expr ? u.filter(h.expr, h.set)[0] : h.set[0]), t) for (h = s ? {
          expr: w.pop(),
          set: _(s)
        ...
        if (c || (c = l), c || u.error(p || e), "[object Array]" === r.call(c)) if (b) if (t && 1 === t.nodeType) for (v = 0; null != c[v]; v++) c[v] && (c[v] === !0 || 1 === c[v].nodeType && u.contains(t, c[v])) && i.push(l[v]);
    ...
    u.uniqueSort = function (e) {
      if (y && (o = l, e.sort(y), o)) for (var t = 1; t < e.length; t++) e[t] === e[t - 1] && e.splice(t--, 1);
      return e
      ...
      var n, s, a, r, o, l;
      if (!e) return [];
      for (s = 0, a = f.order.length; a > s; s++) if (o = f.order[s], (r = f.leftMatch[o].exec(e)) && (l = r[1], r.splice(1, 1), "\\" !== l.substr(l.length - 1) && (r[1] = (r[1] || "").replace(c, ""), n = f.find[o](r, t, i), null != n))) {
      ...
      for (var a, r, o, l, c, d, h, p, m, g = e, v = [], _ = i, b = i && i[0] && u.isXML(i[0]); e && i.length;) {
        for (o in f.filter) if (null != (a = f.leftMatch[o].exec(e)) && a[2]) {
          if (d = f.filter[o], h = a[1], r = !1, a.splice(1, 1), "\\" === h.substr(h.length - 1)) continue;
          if (_ === v && (v = []), f.preFilter[o]) if (a = f.preFilter[o](a, _, n, v, s, b)) {
            if (a === !0) continue
          } else r = l = !0;
          if (a) for (p = 0; null != (c = _[p]); p++) c && (l = d(c, a, p, _), m = s ^ l, n && null != l ? m ? r = !0 : _[p] = !1 : m && (v.push(c), r = !0));
          if (l !== t) {
      ...
      f = u.selectors = {
        ...
        relative: {
          "+": function (e, t) {
            var i = "string" == typeof t,
              ...
              s = i && !n;
            n && (t = t.toLowerCase());
            for (var a, r = 0, o = e.length; o > r; r++) if (a = e[r]) {
              for (;
          ...
          ">": function (e, t) {
            var i, n = "string" == typeof t,
              ...
              a = e.length;
            if (n && !h.test(t)) {
              for (t = t.toLowerCase(); a > s; s++) if (i = e[s]) {
                var r = i.parentNode;
        ...
        filter: {
          PSEUDO: function (e, t, i, n) {
            ...
            if ("not" === s) {
              for (var r = t[3], o = 0, l = r.length; l > o; o++) if (r[o] === e) return !1;
              return !0
            }
            u.error(s)
          },
    ...
    A.documentElement.compareDocumentPosition ? y = function (e, t) {
      ...
      for (var d = 0; i > d && n > d; d++) if (s[d] !== a[d]) return w(s[d], a[d]);
    ...
    }(), u.contains = A.documentElement.contains ?
    function (e, t) {
  ...
  G.fn.extend({
    find: function (e) {
      ...
      if ("string" != typeof e) return G(e).filter(function () {
        for (t = 0, i = n.length; i > t; t++) if (G.contains(n[t], this)) return !0
      });
      var s, a, r, o = this.pushStack("", "find", e);
      for (t = 0, i = this.length; i > t; t++) if (s = o.length, G.find(e, this[t], o), t > 0) for (a = s; a < o.length; a++) for (r = 0; s > r; r++) if (o[r] === o[a]) {
        o.splice(a--, 1);
        break
      }
      return o
    ...
    has: function (e) {
      ...
      return this.filter(function () {
        for (var e = 0, i = t.length; i > e; e++) if (G.contains(this, t[e])) return !0
      })
    },
    not: function (e) {
    ...
    closest: function (e, t) {
      ...
      for (i = 0, n = this.length; n > i; i++) for (a = this[i]; a;) {
  ...
  It.optgroup = It.option, It.tbody = It.tfoot = It.colgroup = It.caption = It.thead, It.th = It.td, G.support.htmlSerialize || (It._default = [1, "div<div>", "</div>"]), G.fn.extend({
    ...
    empty: function () {
      for (var e, t = 0; null != (e = this[t]); t++) for (1 === e.nodeType && G.cleanData(e.getElementsByTagName("*")); e.firstChild;) e.removeChild(e.firstChild);
      return this
    },
    clone: function (e, t) {
    ...
    clone: function (e, t, i) {
      ...
      if (!(G.support.noCloneEvent && G.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || G.isXMLDoc(e))) for (y(e, r), n = b(e), s = b(r), a = 0; n[a]; ++a) s[a] && y(n[a], s[a]);
      if (t && (w(e, r), i)) for (n = b(e), s = b(r), a = 0; n[a]; ++a) w(n[a], s[a]);
      return n = s = null, r
    },
    clean: function (e, t, i, n) {
      ...
      for (var l, c = 0; null != (l = e[c]); c++) if ("number" == typeof l && (l += ""), l) {
        if ("string" == typeof l) if (yt.test(l)) {
          l = l.replace(vt, "<$1></$2>");
        ...
        var b;
        if (!G.support.appendChecked) if (l[0] && "number" == typeof (b = l.length)) for (r = 0; b > r; r++) v(l[r]);
        else v(l);
        l.nodeType ? o.push(l) : o = G.merge(o, l)
      }
      if (i) for (s = function (e) {
        return !e.type || Dt.test(e.type)
      }, c = 0; o[c]; c++) if (a = o[c], n && G.nodeName(a, "script") && (!a.type || Dt.test(a.type))) n.push(a.parentNode ? a.parentNode.removeChild(a) : a);
      else {
        if (1 === a.nodeType) {
    ...
    cleanData: function (e) {
      for (var t, i, n, s = G.cache, a = G.event.special, r = G.support.deleteExpando, o = 0; null != (n = e[o]); o++) if ((!n.nodeName || !G.noData[n.nodeName.toLowerCase()]) && (i = n[G.expando])) {
        if (t = s[i], t && t.events) {
  ...
  Rt = ni.exec(Bt.toLowerCase()) || [], G.fn.extend({
    ...
    ajax: function (e, i) {
      function n(e, i, n, r) {
        if (2 !== k) {
          ...
          var h, p, f, w, x, D = i,
            T = n ? d(m, C, n) : t;
          if (e >= 200 && 300 > e || 304 === e) if (m.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (G.lastModified[s] = w), (x = C.getResponseHeader("Etag")) && (G.etag[s] = x)), 304 === e) D = "notmodified", h = !0;
          else try {
      ...
      var s, a, r, o, l, h, u, f, m = G.ajaxSetup({}, i),
        ...
        C = {
          ...
          getResponseHeader: function (e) {
            var i;
            if (2 === k) {
              if (!r) for (r = {}; i = Wt.exec(a);) r[i[1].toLowerCase()] = i[2];
              i = r[e.toLowerCase()]
            }
            return i === t ? null : i
          },
    ...
    param: function (e, i) {
      ...
      else for (var a in e) h(a, e[a], i, s);
      ...
      return {
        send: function (s, a) {
          ...
          l.send(i.hasContent && i.data || null), n = function (e, s) {
            var o, c, d, h, u;
            try {
              if (n && (s || 4 === l.readyState)) if (n = t, r && (l.onreadystatechange = G.noop, ui && delete hi[r]), s) 4 !== l.readyState && l.abort();
              else {
  ...
  G.fn.extend({
    ...
    animate: function (e, t, i, s) {
      function a() {
        ...
        for (s in e) if (t = G.camelCase(s), s !== t && (e[t] = e[s], delete e[s]), (o = G.cssHooks[t]) && "expand" in o) {
    ...
    stop: function (e, i, n) {
      return "string" != typeof e && (n = i, i = e, e = t), i && e !== !1 && this.queue(e || "fx", []), this.each(function () {
        ...
        var i, s = !1,
          a = G.timers,
          r = G._data(this);
        if (n || G._unmark(!0, this), null == e) for (i in r) r[i] && r[i].stop && i.indexOf(".run") === i.length - 4 && t(this, r, i);
    ...
    step: function (e) {
      ...
      if (e || s >= l.duration + this.startTime) {
        ...
        if (a) {
          ...
          }), l.hide && G(o).hide(), l.hide || l.show) for (t in l.animatedProperties) G.style(o, t, l.orig[t]), G.removeData(o, "fxshow" + t, !0), G.removeData(o, "toggle" + t, !0);
  ...
  var xi, ki = /^t(?:able|d|h)$/i,
    Ci = /^(?:body|html)$/i;
  xi = "getBoundingClientRect" in A.documentElement ?
  function (e, t, n, s) {
    try {
  ...
  var i, n = e.document,
    ...
    o = function (e) {
      ...
      e = a(e);
      for (var s = 0, o = r.length; o > s; s++) if (t = r[s] + e, "string" == typeof i[t]) return t
    },
    l = o("transform"),
  ...
  if (s) for (i in d) s.hasOwnProperty(i) || s.addTest(i, d[i]);
  else {
    s = e.Modernizr = {
  ...
  t.Isotope.settings = {
    ...
    _masonryPlaceBrick: function (e, t) {
      for (var i = Math.min.apply(Math, t), n = 0, s = 0, a = t.length; a > s; s++) if (t[s] === i) {
        n = s;
        break
      }
...
function (e) {
  ...
  t.prototype = {
    ...
    setState: function (e) {
      ...
      e += "Text", n.resetText || i.data("resetText", i[s]()), i[s](n[e] || this.options[e]), setTimeout(function () {
    ...
    return this.each(function () {
      var n = e(this),
        s = n.data("button"),
        a = "object" == typeof i && i;
      s || n.data("button", s = new t(this, a)), "toggle" == i ? s.toggle() : i && s.setState(i)
    })
...
function (e) {
  var t = function (t, i) {
      this.$element = e(t), this.options = e.extend({}, e.fn.carousel.defaults, i), this.options.slide && this.slide(this.options.slide), "hover" == this.options.pause && this.$element.on("mouseenter", e.proxy(this.pause, this)).on("mouseleave", e.proxy(this.cycle, this))
    };
  t.prototype = {
    cycle: function () {
    ...
    to: function (t) {
      ...
      if (!(t > n.length - 1 || 0 > t)) return this.sliding ? this.$element.one("slid", function () {
        a.to(t)
      }) : s == t ? this.pause().cycle() : this.slide(t > s ? "next" : "prev", e(n[t]))
    },
    pause: function () {
    ...
    slide: function (t, i) {
      var n = this.$element.find(".active"),
        ...
        o = "next" == t ? "first" : "last",
        l = this;
      return this.sliding = !0, a && this.pause(), s = s.length ? s : this.$element.find(".item")[o](), s.hasClass("active") ? void 0 : (!e.support.transition && this.$element.hasClass("slide") ? (this.$element.trigger("slide"), n.removeClass("active"), s.addClass("active"), this.sliding = !1, this.$element.trigger("slid")) : (s.addClass(t), s[0].offsetWidth, n.addClass(r), s.addClass(r), this.$element.trigger("slide"), this.$element.one(e.support.transition.end, function () {
        s.removeClass([t, r].join(" ")).addClass("active"), n.removeClass(["active", r].join(" ")), l.sliding = !1, setTimeout(function () {
    ...
    return this.each(function () {
      var n = e(this),
        s = n.data("carousel"),
        a = "object" == typeof i && i;
      s || n.data("carousel", s = new t(this, a)), "number" == typeof i ? s.to(i) : "string" == typeof i || (i = a.slide) ? s[i]() : s.cycle()
    })
    ...
    e("body").on("click.carousel.data-api", "[data-slide]", function (t) {
      var i, n = e(this),
        ...
        a = !s.data("modal") && e.extend({}, s.data(), n.data());
      s.carousel(a), t.preventDefault()
    })
  })
}(window.jQuery), !
function (e) {
  ...
  t.prototype = {
    ...
    show: function () {
      var t, i = this.dimension(),
        n = e.camelCase(["scroll", i].join("-")),
        s = this.$parent && this.$parent.find(".in");
      s && s.length && (t = s.data("collapse"), s.collapse("hide"), t || s.data("collapse", null)), this.$element[i](0), this.transition("addClass", "show", "shown"), this.$element[i](this.$element[0][n])
    },
    hide: function () {
    ...
    transition: function (t, i, n) {
      var s = this,
        a = function () {
          "show" == i && s.reset(), s.$element.trigger(n)
        };
      this.$element.trigger(i)[t]("in"), e.support.transition && this.$element.hasClass("collapse") ? this.$element.one(e.support.transition.end, a) : a()
    },
    toggle: function () {
    ...
    return this.each(function () {
      var n = e(this),
        s = n.data("collapse"),
        a = "object" == typeof i && i;
      s || n.data("collapse", s = new t(this, a)), "string" == typeof i && s[i]()
    })
    ...
    e("body").on("click.collapse.data-api", "[data-toggle=collapse]", function (t) {
      var i, n = e(this),
        ...
        a = e(s).data("collapse") ? "toggle" : n.data();
      e(s).collapse(a)
    })
  })
}(window.jQuery), !
function (e) {
  ...
  n.prototype = {
    ...
    toggle: function () {
      var i, n, s = e(this),
        a = s.attr("data-target");
      return a || (a = s.attr("href"), a = a && a.replace(/.*(?=#[^\s]*$)/, "")), i = e(a), i.length || (i = s.parent()), n = i.hasClass("open"), t(), !n && i.toggleClass("open"), !1
    }
  }, e.fn.dropdown = function (t) {
    return this.each(function () {
      var i = e(this),
        s = i.data("dropdown");
      s || i.data("dropdown", s = new n(this)), "string" == typeof t && s[t].call(i)
    })
  }, e.fn.dropdown.Constructor = n, e(function () {
    e("html").on("click.dropdown.data-api", t), e("body").on("click.dropdown.data-api", i, n.prototype.toggle)
  })
}(window.jQuery), !
function (e) {
  function t() {
    var t = this,
      n = setTimeout(function () {
        t.$element.off(e.support.transition.end), i.call(t)
      }, 500);
    this.$element.one(e.support.transition.end, function () {
      clearTimeout(n), i.call(t)
    })
  }
  function i() {
    this.$element.hide().trigger("hidden"), n.call(this)
  }
  function n(t) {
  ...
  var r = function (t, i) {
      this.options = i, this.$element = e(t).delegate('[data-dismiss="modal"]', "click.dismiss.modal", e.proxy(this.hide, this))
    };
  r.prototype = {
    constructor: r,
    toggle: function () {
    ...
    show: function () {
      var t = this;
      this.isShown || (e("body").addClass("modal-open"), this.isShown = !0, this.$element.trigger("show"), a.call(this), n.call(this, function () {
        var i = e.support.transition && t.$element.hasClass("fade");
        !t.$element.parent().length && t.$element.appendTo(document.body), t.$element.show(), i && t.$element[0].offsetWidth, t.$element.addClass("in"), i ? t.$element.one(e.support.transition.end, function () {
          t.$element.trigger("shown")
        }) : t.$element.trigger("shown")
      }))
    },
    hide: function (n) {
      n && n.preventDefault(), this.isShown && (this.isShown = !1, e("body").removeClass("modal-open"), a.call(this), this.$element.trigger("hide").removeClass("in"), e.support.transition && this.$element.hasClass("fade") ? t.call(this) : i.call(this))
    }
  }, e.fn.modal = function (t) {
    return this.each(function () {
      var i = e(this),
        n = i.data("modal"),
        s = e.extend({}, e.fn.modal.defaults, i.data(), "object" == typeof t && t);
      n || i.data("modal", n = new r(this, s)), "string" == typeof t ? n[t]() : s.show && n.show()
    })
  }, e.fn.modal.defaults = {
    backdrop: !0,
    keyboard: !0,
    show: !0
  }, e.fn.modal.Constructor = r, e(function () {
    e("body").on("click.modal.data-api", '[data-toggle="modal"]', function (t) {
      var i, n = e(this),
        s = e(n.attr("data-target") || (i = n.attr("href")) && i.replace(/.*(?=#[^\s]+$)/, "")),
        a = s.data("modal") ? "toggle" : e.extend({}, s.data(), n.data());
      t.preventDefault(), s.modal(a)
    })
  })
}(window.jQuery), !
function (e) {
  ...
  t.prototype = e.extend({}, e.fn.tooltip.Constructor.prototype, {
    ...
    setContent: function () {
      var t = this.tip(),
        i = this.getTitle(),
        n = this.getContent();
      t.find(".popover-title")["object" == e.type(i) ? "append" : "html"](i), t.find(".popover-content > *")["object" == e.type(n) ? "append" : "html"](n), t.removeClass("fade top bottom left right in")
    },
    hasContent: function () {
    ...
    getContent: function () {
      var e, t = this.$element,
        i = this.options;
      return e = t.attr("data-content") || ("function" == typeof i.content ? i.content.call(t[0]) : i.content), e = e.toString().replace(/(^\s*|\s*$)/, "")
    },
    tip: function () {
    ...
    return this.each(function () {
      var n = e(this),
        s = n.data("popover"),
        a = "object" == typeof i && i;
      s || n.data("popover", s = new t(this, a)), "string" == typeof i && s[i]()
    })
...
window.PR_SHOULD_USE_CONTINUATION = !0, function () {
  function e(e) {
    ...
    function s(e) {
      ...
      if (e.ignoreCase && r) for (o = 0; i > o; ++o) c = t[o], e = c.charAt(0), c.length >= 2 && "[" === e ? t[o] = n(c) : "\\" !== e && (t[o] = c.replace(/[A-Za-z]/g, function (e) {
  ...
  function n(t, n) {
      ...
      for (var t = e.d, c = [t, "pln"], d = 0, h = e.a.match(a) || [], u = {}, p = 0, f = h.length; f > p; ++p) {
        ...
        if ("string" == typeof v) m = !1;
          ...
          if (b) _ = g.match(b[1]), v = b[0];
            ...
            for (m = 0; l > m; ++m) if (b = n[m], _ = g.match(b[1])) {
              v = b[0];
              break
            }
            _ || (v = "pln")
    ...
    function () {
      for (var i = t.concat(n), s = [], o = {}, l = 0, c = i.length; c > l; ++l) {
        var d = i[l],
          h = d[3];
        if (h) for (var u = h.length; --u >= 0;) r[h.charAt(u)] = d;
  ...
  function a(e, t) {
    function i(e) {
      ...
      case 1:
        ...
        else for (e = e.firstChild; e; e = e.nextSibling) i(e);
        break;
      case 3:
      case 4:
        if (l) {
  ...
  r(_, ["default-code"]), r(n([], [
    ...
    ["lang-in.tag", /^(<\/?[a-z][^<>]*>)/i]
  ]), ["default-markup", "htm", "html", "mxml", "xhtml", "xml", "xsl"]), r(n([
    ["pln", /^\s+/, q, " 	\r\n"],
    ["atv", /^(?:"[^"]*"?|'[^']*'?)/, q, "\"'"]
  ], [
    ["tag", /^^<\/?[a-z](?:[\w-.:]*\w)?|\/?>$/i],
    ...
    function t() {
      for (var i = window.PR_SHOULD_USE_CONTINUATION ? c.now() + 250 : 1 / 0; h < n.length && c.now() < i; h++) {
        ...
        if (r.indexOf("prettyprint") >= 0) {
          ...
          for (p && (r = o.className.match(u)), r && (r = r[1]), p = !1, f = s.parentNode; f; f = f.parentNode) if (("pre" === f.tagName || "code" === f.tagName || "xmp" === f.tagName) && f.className && f.className.indexOf("prettyprint") >= 0) {
            p = !0;
            break
          }
    ...
    for (var i = [document.getElementsByTagName("pre"), document.getElementsByTagName("code"), document.getElementsByTagName("xmp")], n = [], s = 0; s < i.length; ++s) for (var r = 0, o = i[s].length; o > r; ++r) n.push(i[s][r]);
    var i = q,
      c = Date;
    c.now || (c = {
      now: function () {
...
function (e) {
  ...
  function t(i) {
    for (var n, s = e(i.currentTarget); s.data("peUtilsLoader") && (n = s.data("peUtilsLoader").shift());) if (--n.total <= 0) {
      var a = n.callback,
        r = n.target;
  ...
  (void 0 == $.prop || $().jquery < "1.6") && ($.fn.prop = function (e, t) {
    ...
    function PPlayer(srcNode, cfg, onReady) {
      return this.config = new projekktorConfig("0.9.08"), this._persCfg = ["enableNativePlayback", "enableFlashFallback"], this._queue = [], this.env = {
        ...
        for (var o in e.file) if ("config" != o && ("string" == typeof e.file[o] && (e.file[o] = {
          src: e.file[o]
        }), void 0 != e.file[o].src)) {
          try {
        ...
        for (var o in e.file) if (e.file[o].type == s[0].type || "none/none" == s[0].type) {
          result = {
            setup: e.file,
            ID: this.randomId(8),
            type: e.file[o].type,
        ...
        this.env.loading = !0, function () {
          try {
            if (t._plugins.length > 0) for (var i = 0; i < t._plugins.length; i++) if (t._plugins[i].pluginReady !== !0) return setTimeout(arguments.callee, 50), void 0;
        ...
        if (!(this._plugins.length > 0) && 0 != plugins) for (var i = 0; i < plugins.length; i++) {
        ...
        if (0 != this._plugins.length) for (var t = e || $.merge($.merge([], this.config._plugins), this.config._addplugins), i = this._plugins.length, n = 0; n < t.length; n++) for (var s = 0; i > s; s++) void 0 != this._plugins[s] && this._plugins[s].name == t[n].toLowerCase() && (this._plugins[s].deconstruct(), this._plugins.splice(s, 1))
        ...
        if ("time" != i && "progress" != i && "mousemove" != i && this._debug("Fireing :" + i), this._plugins.length > 0) for (var n in this._plugins) try {
          this._plugins[n][i + "Handler"](t, this)
        } catch (s) {}
        if (this.listeners.length > 0) for (var n in this.listeners) try {
        ...
        for (var i in t) if ($.inArray(t[i], this._compTableCache.all) > -1) return !0;
        return !1
        ...
        for (var e = navigator.userAgent.toLowerCase(), t = ["android", "windows ce", "blackberry", "palm", "mobile"], i = 0; i < t.length; i++) if (e.indexOf(t[i]) > -1) return !0;
        return !1
        ...
        for (var n in e) if ($.inArray(n, this._persCfg) > -1 && this._cookie(n, this._cleanValue(e[n])), void 0 == this.config["_" + n]) if (i = this._cleanValue(e[n]), "*" != t) {
        ...
        function (e) {
          return e
        } : decodeURIComponent, r = (s = new RegExp("(?:^|; )" + encodeURIComponent(this.config._cookieName + "_" + e) + "=([^;]*)").exec(document.cookie)) ? a(s[1]) : null;
        ...
        var i = t.FlashVars || {},
          ...
          o = "";
        t.src += "?";
        for (var l in i) if ("function" != typeof i[l]) {
          r = i[l];
        ...
        for (var e = "", t = {
          all: [],
          media: []
        }, i = 0; i < $p.mmap.length; i++) if (!($.inArray($p.mmap[i].type, t.all) > -1)) if ("all|internal".indexOf($p.mmap[i].platform) > -1) t.all.push($p.mmap[i].type);
        ...
        if (i = a.pathname.replace(/\/[^\/]*$/, ""), n = e.match(/\.\.\//g)) for (e = e.substring(3 * n.length), s = n.length; s--;) i = i.substring(0, i.lastIndexOf("/"));
        return t + i + "/" + e
        ...
        if (this.config._debug !== !1) if ("console" != this.config._debug) {
          var i = "<pre><b>" + e + "</b>\n";
        ...
        for (var i in this.config._playlist[0]) if (this.config._playlist[0][i].type && (this.config._playlist[0][i].type.indexOf("/json") > -1 || this.config._playlist[0][i].type.indexOf("/xml") > -1)) return this.setFile(this.config._playlist[0][i].src, !0, this.config._playlist[0][i].type), this;
        ...
        if ("object" == typeof data.config.plugins) for (var i = 0; i < data.config.plugins.length; i++) try {
        ...
        })), this.env.playerDom.addClass(data.id).addClass(data.variation), "object" == typeof data.config) for (var i in data.config) void 0 != this.config["_" + i] ? this.config["_" + i] = data.config[i] : this.config[i] = data.config[i];
  ...
  playerModel.prototype = {
    ...
    _waitforPlayer: function () {
      if (1 != this.elementReady) {
        var e = this;
        this._setBufferState("empty"), function () {
          try {
...
jQuery(function (e) {
  projekktorControlbar.prototype = {
    ...
    initialize: function () {
      ...
      for (var s in this.controlElementsConfig) if (t.match(new RegExp(n + s, "gi"))) {
        i = !1;
        break
      }
...
jQuery(function (e) {
  projekktorDisplay.prototype = {
    ...
    leftclickHandler: function (t) {
      ...
      if (-1 != e(t.target).attr("id").indexOf("_media")) return "ERROR" == this.pp.getState() ? (this.pp.setActiveItem("next"), void 0) : (1 != this.pp.getHasGUI() && (this.displayClicks++, this.displayClicks > 0 && setTimeout(function () {
        if (1 == i.displayClicks) if ("PLAYING" == i.pp.getState()) try {
      ...
      if (clearTimeout(this.bufferDelayTimer), !this.pp.getHasGUI()) {
        ...
        this.buffIcn.stop(!0, !0), this.buffIcn.hasClass("active") || this.buffIcn.fadeIn("fast", function () {
          if (null != t.buffIcnSprite) {
            ...
            t.buffIcnSprite.addClass("active").removeClass("inactive").css("display", ""), function () {
  ...
  function t(e, t, i, n) {
    var o, l, c, d, h = !1,
      u = !1;
    e = e ? e : "";
    for (var p in s) if ("string" == typeof p && (o = e.match(s[p]), o && o.length > 0)) {
    ...
    if (!c) {
      var f = e.match(r);
      if (f) {
        if (l = "local", c = [f[0]], t) for (t = t.split(","), d = 0; d < t.length; d++) c.push(f[1] + t[d])
      } else c = !1
    }
    if (n) {
      var m = n.split(/x| |,/);
  ...
  function i(i, s) {
    ...
    function c() {
      if (w) return !1;
      if (!e.pixelentity.browser.mobile) for (var t = 0; t < n.length; t++) t != y && n[t].disable();
  ...
  function t() {
    ...
    for (var t in e) if ("undefined" != typeof l[t]) return e[t];
    return null
  }
  function i() {
    var e = ["transformProperty", "WebkitTransform", "MozTransform", "OTransform", "msTransform"];
    for (var t in e) if (void 0 !== l[e[t]]) return !0;
    return !1
  }
  ...
  function t() {
    ...
    function p() {
      if (nt.hasClass("peFlareLightboxActive")) if (e.pixelentity.browser.mobile || "youtube" == At.videoType || "vimeo" == At.videoType) {
  ...
  function t(t, n, s) {
    ...
    function c() {
      return v || (v = e('<div class="peFlareLightboxRenderImage" />').append(u.addClass(m.scale)), u.wrap("<div/>")), v
    }
    function d(t) {
  ...
  function t(t, n, s) {
    function a(e) {
      return f = e, i.signal("locked", t), h(e), this
    }
    function r(e, t) {
      return n = e, s = t, p && p.resize(n, s), this
    }
    function o() {
      i.signal("loaded", t)
    }
    ...
    function c() {
      return setTimeout(d, 50), g
    }
    function d() {
      p && p.gogo()
    }
    function h(t) {
      m = !0, p || (g = e('<div class="peFlareLightboxRenderGallery" />'), i.addToBuffer(g), p = g.peBackgroundSlider({
        api: !0,
        wait: !0
      }), p.bind("loaded.pixelentity", o), p.bind("complete.pixelentity", l)), p.load(t.resource, t.bw), p.configure("fillmax", "center,center")
    }
    function u() {
      g && (g.detach(), g = void 0), p && (p.unbind("loaded.pixelentity", o), p.unbind("complete.pixelentity", l), p.destroy(), p = void 0), i.signal("destroy", t)
    }
    var p, f, m = !1,
      g = !1;
    e.extend(this, {
  ...
  var i;
  e.pixelentity && (i = e.pixelentity.lightbox) && i.register(t, "shutter")
}(jQuery), function (e) {
  function t(t, n) {
    function a() {
      W = !0;
  ...
  o && (c = "WebKitCSSMatrix" in window && "m11" in new WebKitCSSMatrix, n = i + "Transition", l = n in a ? n : !1), l || (s = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame ||
  function (e) {
    setTimeout(e, 25)
  ...
  function t(t) {
    ...
    function r(e) {
      g && g.find("a").removeClass("fa-circle").eq(e).addClass("fa-circle")
    }
    function o(e, t) {
      r(t.slideIdx - 1)
    }
    function l() {
      f = e('<div class="peVoloPrev"><a href="#" class="fa fa-chevron-left"></a></div>').find("a").click(n).end().hide(), m = e('<div class="peVoloNext"><a href="#" class="fa fa-chevron-right"></a></div>').find("a").click(s).end().hide(), g = e('<div class="peVoloBullets"></div>').hide();
      for (var o = 0; p > o; o++) g.append('<a href="#" data-idx="' + o + '" class="fa fa-circle-o"></a>').delegate("a", "click", a);
  ...
  function i(i, r) {
    ...
    function d(t) {
      if (h(t), n) {
        if (n.get(u).length > 0) for (var i; i = n.get(u).pop();) i(t);
        n.set(u, {
          time: e.now(),
          tweets: t
        })
  ...
  function t(t, s) {
    ...
    function l(t) {
      if (c(t), i) {
        if (i.get(d).length > 0) for (var n; n = i.get(d).pop();) n(t);
        i.set(d, {
          time: e.now(),
          photos: t
        })
  ...
  pixelentity.classes.Controller = function () {
    ...
    function s(e) {
      ...
      else for (var r = 0; r < n.length; r++) t = n.eq(r), a + t.width() > s && t.addClass("rightAlign")
    }
    function a() {
  ...
  }), e(".expanded .dropdown-menu").exists() && e(".expanded .dropdown-menu").addClass("sub-menu"), e(".form-item-search-block-form input.form-text").attr("placeholder", "Search..."), e(".view .item-list").exists() && (e(".item-list .pager").addClass("pagination").removeClass("pager"), e(".item-list .pager-current").addClass("active"))
});