 ...
 */
?>
  <div id="isotope-container" class="peIsotopeContainer row">
    <?php $count = 0; ?>
    <?php foreach ( $rows as $id => $row ): ?>
      ...
      ?>
      <div class="span2 peIsotopeItem isotope-element isotope-element-<?php print $count; ?> <?php print $classlist; ?>" data-category="<?php print $classlist; ?>" <?php print $bgstyle ?>>
        <?php print $row; ?>
      </div>
      <?php 
      // reset
