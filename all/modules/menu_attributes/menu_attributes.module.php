...
function menu_attributes_menu_attribute_info() {
  ...
  $info['data-divider'] = array(
  		'label' => t('Add Divider'),
  		'description' => t('Add a divider before this list item?'),
		 'form' => array(
		      '#type' => 'checkbox',
		 	),
  		'scope' => array(MENU_ATTRIBUTES_ITEM),
  );
  $info['data-header'] = array(
  		'label' => t('Heading Text'),
  		'description' => t('Add a header before this list item?'),
  		'form' => array(
  				'#maxlength' => 12,
  				'#size' => 12,
  		),
  ...
  $info['data-badge'] = array(
  		'label' => t('Badge/Label Text'),
  		'description' => t('Specify the text to be displayed within the badge/label.'),
  		'form' => array(
  				'#maxlength' => 10,
  				'#size' => 10,
  		),
  ...
  $info['data-color'] = array(
  		'label' => t('Badge/Label Class'),
  		'description' => t('Add text to the label.'),
  		'form' => array(
  				'#maxlength' => 60,
  				'#size' => 20,
  		),
  ...
  $info['data-icon'] = array(
  		'label' => t('Icon Class'),
  		'description' => t('Add an icon class to this menu link.'),
  		'form' => array(
  				'#maxlength' => 60,
  				'#size' => 60,
  		),
